...
insert into place_type(id_place_type,description) values(3,'Pátio');
insert into place_type(id_place_type,description) values(4,'CLASS ROOM');
insert into place_type(id_place_type,description) values(5,'TEACHER ROOM');
insert into place_type(id_place_type,description) values(6,'Auditório');
